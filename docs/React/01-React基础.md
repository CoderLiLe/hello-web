...
- [React介绍](#react介绍)
  - [React的优势](#react的优势)
  - [React的市场情况](#react的市场情况)
- [开发环境创建](#开发环境创建)
- [JSX基础](#jsx基础)
  - [什么是JSX](#什么是jsx)
  - [JSX的本质](#jsx的本质)
  - [JSX高频场景-JS表达式](#jsx高频场景-js表达式)
  - [JSX高频场景-列表渲染](#jsx高频场景-列表渲染)
  - [JSX高频场景-条件渲染](#jsx高频场景-条件渲染)
  - [JSX高频场景-复杂条件渲染](#jsx高频场景-复杂条件渲染)
- [React的事件绑定](#react的事件绑定)
  - [基础实现](#基础实现)
  - [使用事件参数](#使用事件参数)
  - [传递自定义参数](#传递自定义参数)
  - [同时传递事件对象和自定义参数](#同时传递事件对象和自定义参数)
- [React组件基础使用](#react组件基础使用)
  - [组件是什么](#组件是什么)
  - [组件基础使用](#组件基础使用)
- [组件状态管理-useState](#组件状态管理-usestate)
  - [基础使用](#基础使用)
  - [状态的修改规则](#状态的修改规则)
  - [修改对象状态](#修改对象状态)
- [组件的基础样式处理](#组件的基础样式处理)
...
![image.png](assets/01/09.png)
## 修改对象状态
> 对于对象类型的状态变量，应该始终给set方法一个`全新的对象` 来进行修改

![image.png](assets/01/10.png)
# 组件的基础样式处理
