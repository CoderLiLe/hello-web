...
- [Redux快速体验](#redux快速体验)
  - [1. 实现计数器](#1-实现计数器)
  - [2. Redux数据流架构](#2-redux数据流架构)
- [Redux与React - 环境准备](#redux与react---环境准备)
  - [1. 配套工具](#1-配套工具)
  - [2. 配置基础环境](#2-配置基础环境)
  - [3. store目录结构设计](#3-store目录结构设计)
- [Redux与React - 实现counter](#redux与react---实现counter)
  - [1. 整体路径熟悉](#1-整体路径熟悉)
  - [2. 使用React Toolkit 创建 counterStore](#2-使用react-toolkit-创建-counterstore)
  - [3. 为React注入store](#3-为react注入store)
  - [4. React组件使用store中的数据](#4-react组件使用store中的数据)
  - [5. React组件修改store中的数据](#5-react组件修改store中的数据)
- [Redux与React - 提交action传参](#redux与react---提交action传参)
- [Redux与React - 异步action处理](#redux与react---异步action处理)
- [Redux调试 - devtools](#redux调试---devtools)
- [美团小案例](#美团小案例)
  - [1. 案例演示](#1-案例演示)
  - [2. 准备并熟悉环境](#2-准备并熟悉环境)
  - [3. 分类和商品列表渲染](#3-分类和商品列表渲染)
  - [4. 点击分类激活交互实现](#4-点击分类激活交互实现)
  - [5. 商品列表切换显示](#5-商品列表切换显示)
  - [6. 添加购物车实现](#6-添加购物车实现)
  - [7. 统计区域实现](#7-统计区域实现)
  - [8. 购物车列表功能实现](#8-购物车列表功能实现)
  - [9. 控制购物车显示和隐藏](#9-控制购物车显示和隐藏)
...
![image.png](assets/03/12.png)
# 美团小案例
## 1. 案例演示
![image.png](assets/03/13.png)
